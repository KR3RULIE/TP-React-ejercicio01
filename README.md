...
Este es un proyecto básico de una aplicación web que muestra el mensaje **"Hello World"** en pantalla.
...
```bash
git clone https://github.com/KR3RULIE/TP-React-ejercicio01
```
